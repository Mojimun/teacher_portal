...
(function (factory) {
  ...
  fn.extend({
    ...
    closest: function (selector) {
		$(".drop_down_close_btn").addClass("drop_down_close_btn_hide");
		$(".drop_down_close_btn").removeClass("drop_down_close_btn_show");
  ...
  var Dropdown = function (_Component2) {
    ...
    _createClass(Dropdown, [{
      ...
      value: function _handleDocumentClick(e) {
        ...
        var $target = $(e.target);
		// --- MT hack for mCustomScrollbar with materialize select
		if($target[0].className.includes("mCSB_")){
			return;
		}
